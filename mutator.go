...
/*
  - The ChoiceType that the mutator can handle have specific
    choices eventually will be used when sending events to the
    target service. Some of them are reusable accross services,
    like boolean or integer choice. But like node selection,
    is service-specific. It is better to have a generic mutator
    and a set of generic mutating choice types, then some
    specific mutators and specific mutators. The mutation process
    should mix them to generate the final mutation result *
*/
