...
/*
  - The tCtx here eventually will be passed to the Raft environment.
    But in there, the only usage is to call ctx.AddEvent to send what happens in the Raft system.
*/
